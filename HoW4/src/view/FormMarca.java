...
public class FormMarca extends javax.swing.JDialog {
    ...
    DAOMarca dao = new DAOMarca(); //DAOAutor
    ...
    private void initComponents() {
        ...
        listObjetos = org.jdesktop.observablecollections.ObservableCollections.observableList(new ArrayList<ModelMarca>())
        ;
    ...
    private void btnNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoActionPerformed
        ...
        listObjetos.add((ModelMarca) new ModelMarca());
        int linha = listObjetos.size() - 1;
        tblObjetos.setRowSelectionInterval(linha, linha);
        trataEdicao(true);
        txtNome.requestFocus();
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        if (validaCampos()) {
            ...
            ModelMarca obj = listObjetos.get(linhaSelecionada);
            dao.salvar(obj);
            trataEdicao(false);
            atualizaTabela();
    ...
    private java.util.List<ModelMarca> listObjetos;
