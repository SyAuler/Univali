...
public class FormCarro extends javax.swing.JDialog {
    ...
    public void atualizaTabela() {
        listObjetos.clear();
        listObjetos.addAll(daoCarro.getLista());
    ...
    public FormCarro(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        
        listModelo.clear();
        listMarca.clear();
        listModelo.addAll(daoModelo.getLista());
    ...
    private void trataEdicao(boolean editando) {
        ...
        cbxModelo.setEnabled(editando);
        cbxMarca.setEnabled(editando);               
        txtCor.setEnabled(editando);
        txtAno.setEnabled(editando);
        txtAreaObservacao.setEnabled(editando);
    ...
    public boolean validaCampos() {
        ...
        if (!(txtDescricao.getText().length() > 0)) {
            JOptionPane.showMessageDialog(null, "Informe a descrição do carro");
            txtDescricao.requestFocus();
            return false;
        }

        if (!(cbxModelo.getSelectedIndex() >= 0)) {
            JOptionPane.showMessageDialog(null, "Informe o modelo do carro");
            cbxModelo.requestFocus();
            return false;
        }

        if (!(cbxMarca.getSelectedIndex() >= 0)) {
            JOptionPane.showMessageDialog(null, "Informe a marca do carro");
            cbxMarca.requestFocus();
            return false;
        }
        
        if (!(txtCor.getText().length() > 0)) {
            JOptionPane.showMessageDialog(null, "Informe a cor do carro");
            txtCor.requestFocus();
            return false;
        }
        
        if (!(txtAno.getText().length() > 0)) {
            JOptionPane.showMessageDialog(null, "Informe o ano do carro");
            txtAno.requestFocus();
            return false;
        }
        return true;
    ...
    private void initComponents() {
        ...
        listObjetos = org.jdesktop.observablecollections.ObservableCollections.observableList(new ArrayList<model.ModelCarro>())
        ;
        listModelo = org.jdesktop.observablecollections.ObservableCollections.observableList(new ArrayList<model.ModelModelo>());
        listMarca = org.jdesktop.observablecollections.ObservableCollections.observableList(new ArrayList<ModelMarca>());
        ...
        columnBinding.setColumnClass(model.ModelModelo.class);
        ...
        columnBinding.setColumnClass(model.ModelMarca.class);
        ...
        jLabel_filme.setText("Descrição");

        jLabel_produtora.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        jLabel_produtora.setText("Modelo");
        ...
        cbxModelo.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N

        org.jdesktop.swingbinding.JComboBoxBinding jComboBoxBinding = org.jdesktop.swingbinding.SwingBindings.createJComboBoxBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, listModelo, cbxModelo);
        bindingGroup.addBinding(jComboBoxBinding);
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, tblObjetos, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.produtora}"), cbxModelo, org.jdesktop.beansbinding.BeanProperty.create("selectedItem"));
        bindingGroup.addBinding(binding);

        jLabel_duracao.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        jLabel_duracao.setText("Cor");

        txtCor.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, tblObjetos, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.duracao}"), txtCor, org.jdesktop.beansbinding.BeanProperty.create("text"));
        bindingGroup.addBinding(binding);

        jLabel_autor.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        jLabel_autor.setText("Marca");

        cbxMarca.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N

        jComboBoxBinding = org.jdesktop.swingbinding.SwingBindings.createJComboBoxBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, listMarca, cbxMarca);
        bindingGroup.addBinding(jComboBoxBinding);
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, tblObjetos, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.autor}"), cbxMarca, org.jdesktop.beansbinding.BeanProperty.create("selectedItem"));
        bindingGroup.addBinding(binding);

        jLabel_sinopse.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        jLabel_sinopse.setText("Observações");

        txtAreaObservacao.setColumns(20);
        txtAreaObservacao.setFont(new java.awt.Font("Monospaced", 0, 16)); // NOI18N
        txtAreaObservacao.setRows(5);

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, tblObjetos, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.sinopse}"), txtAreaObservacao, org.jdesktop.beansbinding.BeanProperty.create("text"));
        bindingGroup.addBinding(binding);

        jScrollPane2.setViewportView(txtAreaObservacao);

        jLabel_duracao1.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        jLabel_duracao1.setText("Ano");
            ...
            .addGroup(abaDadosLayout.createSequentialGroup()
                .addGroup(abaDadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, abaDadosLayout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(jLabel_duracao1)))
                .addGap(18, 18, 18)
                .addGroup(abaDadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(abaDadosLayout.createSequentialGroup()
                        .addGroup(abaDadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(cbxMarca, javax.swing.GroupLayout.PREFERRED_SIZE, 300, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txtCodigo, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txtDescricao)
                            .addComponent(cbxModelo, javax.swing.GroupLayout.PREFERRED_SIZE, 300, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoActionPerformed
        ...
        listObjetos.add((ModelCarro) new ModelCarro());
        int linha = listObjetos.size() - 1;
        tblObjetos.setRowSelectionInterval(linha, linha);
        trataEdicao(true);
        txtDescricao.requestFocus();
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        if (validaCampos()) {
            ...
            ModelCarro obj = listObjetos.get(linhaSelecionada);
            daoCarro.salvar(obj);
            trataEdicao(false);
            atualizaTabela();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormCarro dialog = new FormCarro(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JLabel jLabel_duracao1;
    ...
    private java.util.List<ModelMarca> listMarca;
    private java.util.List<model.ModelModelo> listModelo;
    private java.util.List<model.ModelCarro> listObjetos;
